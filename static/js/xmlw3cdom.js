...
// Bleach.dev<tm> patch: added iterator to node lists
DOMNodeList.prototype[Symbol.iterator] = function() {
  var index = -1;
  var data  = this._nodes;
...
DOMElement.prototype.getAttribute = function DOMElement_getAttribute(name) {
  ...
  // Bleach.dev<tm> patch: recast to string to fix comparisons
  return String(ret); // if Attribute exists, return its value, otherwise, return ""
};
